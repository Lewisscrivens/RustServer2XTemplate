...
namespace Oxide.Plugins
{
    ...
    public class DiscordRewards : CovalencePlugin
    {
        ...
        private void ChatCMD(IPlayer player)
        {
            ...
            player.Message(string.Format(lang.GetMessage("Verify", this, player.Id), code) + " go to www.CreepyOutpost.com to join the Discord and Steam Group! Follow instructions there.");
        }
